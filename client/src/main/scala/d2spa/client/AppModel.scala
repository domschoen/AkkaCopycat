...
case object ChangeTemperature extends Action
...
case class Ensure(definition: Definition) extends Action
case object InitClient extends Action

case class RegisterInstances(app: String, instances: Option[List[Instance]]) extends Action
