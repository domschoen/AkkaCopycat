...
object WebSocketMessages {
  ...
  final case class GetInstances(definition: Definition) extends WebSocketMsgIn
  ...
  final case class InstancesResponseMsg(app: String, instances: Option[List[Instance]]) extends WebSocketMsgOut
...
object Server {
  val server1 = "chx-istprod-01.hq.k.grp"
  val server2 = "chx-istprod-02.hq.k.grp"
  val server3 = "chx-istprod-03.hq.k.grp"
}

case class Definition(app: String, allocations: Map[String, Int])
...
case class Instance (
                      ...
                      scheduled: Boolean,
                      autoRecover: Boolean,
                      monitorActions: List[String] = List()
                    )


object MonitorAction {
  val turnScheduledOn = "turnScheduledOn"
  val turnScheduledOff = "turnScheduledOff"
  val turnAutoRecoverOff = "turnAutoRecoverOff"
  val stop = "stop"
}
